(function($){
  ...
  jQuery('.has-submenu:first').children('ul').addClass('submenu');
  jQuery('.has-megamenu').children('ul').addClass('megamenu');
  jQuery('.has-submenu:last').children('ul').addClass('submenu');

  jQuery('.has-submenu').removeClass('has-submenu');


  jQuery('.submenu').parent('li').addClass('has-submenu');

  jQuery('.has-megamenu').children('li').addClass('has-submenu');
