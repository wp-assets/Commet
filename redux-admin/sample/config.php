...
$opt_name = 'comet';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Comet Options', 'comet' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Comet Options', 'comet' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header Option', 'comet' ),
		'id'               => 'header',
		'desc'             => esc_html__( 'Change your logo here!', 'your-textdomain-here' ),
		...
		'fields'=> array(
			array(
				...
				'type'     => 'media',
				'url'     => true,
				'title'    => esc_html__( 'Light Logo', 'comet' ),
				'subtitle' => esc_html__( 'Click to change logo', 'comet' ),
				'default'  => array(
			...
			array(
				...
				'type'     => 'media',
				'url'     => true,
				'title'    => esc_html__( 'Drak Logo', 'comet' ),
				'subtitle' => esc_html__( 'Click to change logo', 'comet' ),
				'default'  => array(
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Blog Option', 'comet' ),
		'id'               => 'blog',
		'desc'             => esc_html__( 'Change your logo here!', 'your-textdomain-here' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
		'fields'=> array(
			...
			array(
				'id'       => 'blog-des',
				'type'     => 'text',
				'title'    => esc_html__( 'Change your blog description', 'comet' ),
				'subtitle' => esc_html__( 'Click to change description', 'comet' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'=> esc_html__( 'Footer Option', 'comet' ),
		'id'=>'footer-text',
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
		'fields'=> array(
			array(
				...
				'subtitle'=>'change copyright text',
				'default'=> '© 2022 Comet By Iman Ali.',
			),
			array(
				'id'=>'facebook_url',
				'type'=>'text',
				'title'=>'Facebook',
				'subtitle'=>'change facebook profile link',
				'default'=> 'http://facebook.com/alorchokh',
			),
			array(
				'id'=>'twitter_url',
				'type'=>'text',
				'title'=>'Twotter',
				'subtitle'=>'change twitter profile link',
				'default'=> 'http://twitter.com/@alorchokh',
			),
			array(
				'id'=>'linkedin_url',
				'type'=>'text',
				'title'=>'Linkedin',
				'subtitle'=>'change linkedin profile link',
			...
			array(
				...
				'type'=>'text',
				'title'=>'Instagram',
				'subtitle'=>'change instagram profile link',
			...
			array(
				...
				'type'=>'text',
				'title'=>'Dribbble',
				'subtitle'=>'change dribbble profile link',
